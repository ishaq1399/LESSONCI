<div class="row">
    ...
    <form class="user" action="<?php echo base_url().'Mahasiswa/inputGrup';?>" method="post">
        <div class="form-group">
             <input type="text" class="form-control form-control-user" id="username" name="grup" placeholder="Grup max 7 Character" require>
        </div>
        <!-- <div class="form-group">
